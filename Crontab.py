...
#        output = os.system('crontab -l')
        ...
        for i in range(0, len(string),6):
            ...
            content +='<form action="/list" method="post"><div class="field"><label> <input type="text" value="'+string[i-1]+'" name ="cronjob" id="cronjob" class="textbox"><input type="submit"  value = "run this job" style="width: 80; height: 30"></input></div></form>'
        content +='{% end %}'
        f.write(content)
